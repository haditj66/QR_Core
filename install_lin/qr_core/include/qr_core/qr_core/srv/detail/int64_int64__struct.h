...
enum
{
  qr_core__srv__Int64Int64_Event__request__MAX_SIZE = 1
};
// response
enum
{
  qr_core__srv__Int64Int64_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/Int64Int64 in the package qr_core.
typedef struct qr_core__srv__Int64Int64_Event
{
  service_msgs__msg__ServiceEventInfo info;
  qr_core__srv__Int64Int64_Request__Sequence request;
  qr_core__srv__Int64Int64_Response__Sequence response;
} qr_core__srv__Int64Int64_Event;

// Struct for a sequence of qr_core__srv__Int64Int64_Event.
typedef struct qr_core__srv__Int64Int64_Event__Sequence
{
