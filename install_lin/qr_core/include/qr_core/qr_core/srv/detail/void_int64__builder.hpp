...
class Init_VoidInt64_Event_response
{
public:
  explicit Init_VoidInt64_Event_response(::qr_core::srv::VoidInt64_Event & msg)
  : msg_(msg)
  {}
  ::qr_core::srv::VoidInt64_Event response(::qr_core::srv::VoidInt64_Event::_response_type arg)
  {
...
private:
  ::qr_core::srv::VoidInt64_Event msg_;
};

class Init_VoidInt64_Event_request
{
public:
  explicit Init_VoidInt64_Event_request(::qr_core::srv::VoidInt64_Event & msg)
  : msg_(msg)
  {}
  Init_VoidInt64_Event_response request(::qr_core::srv::VoidInt64_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_VoidInt64_Event_response(msg_);
  }
...
class Init_VoidInt64_Event_info
{
public:
  Init_VoidInt64_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_VoidInt64_Event_request info(::qr_core::srv::VoidInt64_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_VoidInt64_Event_request(msg_);
  }
...
template<>
inline
auto build<::qr_core::srv::VoidInt64_Event>()
{
  return qr_core::srv::builder::Init_VoidInt64_Event_info();
}
