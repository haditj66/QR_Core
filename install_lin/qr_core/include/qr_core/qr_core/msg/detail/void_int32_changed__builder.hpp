...
class Init_VoidInt32Changed_id
{
public:
  Init_VoidInt32Changed_id()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_VoidInt32Changed_data id(::qr_core::msg::VoidInt32Changed::_id_type arg)
  {
...
{
  return qr_core::msg::builder::Init_VoidInt32Changed_id();
}
