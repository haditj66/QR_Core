...
static rosidl_typesupport_introspection_c__MessageMember qr_core__msg__VoidInt64Changed__rosidl_typesupport_introspection_c__VoidInt64Changed_message_member_array[3] = {
  {
    "id1",  // name
    ...
    offsetof(qr_core__msg__VoidInt64Changed, id1),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(qr_core__msg__VoidInt64Changed, id2),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
