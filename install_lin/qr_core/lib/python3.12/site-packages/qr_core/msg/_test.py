...
class Test(metaclass=Metaclass_Test):
    ...
    def __init__(self, **kwargs):
        ...
        self.blablas = kwargs.get('blablas', str())
    ...
    @builtins.property
    def blablas(self):
        """Message field 'blablas'."""
        return self._blablas

    @blablas.setter
    def blablas(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'blablas' field must be of type 'str'"
        self._blablas = value
