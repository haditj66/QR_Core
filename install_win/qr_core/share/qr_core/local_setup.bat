...
set "AMENT_ENVIRONMENT_HOOKS[qr_core]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qr_core] "%AMENT_CURRENT_PREFIX%\share\qr_core\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qr_core] "%AMENT_CURRENT_PREFIX%\share\qr_core\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[qr_core] "%AMENT_CURRENT_PREFIX%\share\qr_core\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[qr_core]:;=";"%") do (
    call:call_file %%f
  )
