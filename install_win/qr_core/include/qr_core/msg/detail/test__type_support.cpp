...
{
  new (message_memory) qr_core::msg::Test(_init);
}

void Test_fini_function(void * message_memory)
{
  auto typed_message = static_cast<qr_core::msg::Test *>(message_memory);
  typed_message->~Test();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_message_member_array[1] = {
  {
    ...
    offsetof(qr_core::msg::Test, blablas),  // bytes offset in struct
...
get_message_type_support_handle<qr_core::msg::Test>()
{
  return &::qr_core::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, qr_core, msg, Test)() {
  return &::qr_core::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
